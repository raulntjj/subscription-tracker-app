const en = {
  ...
  autoFetchHint: "Enter a URL and we'll try to auto-fill the fields.",
  autoFetching: 'Fetching info...',
  autoFetchSuccess: 'Fields auto-filled!',
  autoFetchFailed: 'Could not auto-fill. Please fill in manually.',
